Here is the revised content in YAML format:
...
prompt_design:
  ...
  similarities_with_web_design:
    ...
    - "Both need to adapt their content to different sizes — screen sizes for web design, context windows for prompting."
...
This YAML format organizes the content into clear sections, making it easy to reference specific topics related to prompt design and its comparison to web design.
